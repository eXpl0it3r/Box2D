...
public:
	...
	/// Call this if you want to establish collision that was previously disabled by b2::ContactFilter::ShouldCollide.
	void Refilter();
	...
	/// of the body. You must call b2::Body::ResetMassData to update the body's mass.
