...
public:
	Prismatic()
	{
...

		{
			...
			// Bouncy limit
			b2::Vec2 axis(2.0f, 1.0f);
			axis.Normalize();
			pjd.Initialize(ground, body, b2::Vec2(0.0f, 0.0f), axis);

			// Non-bouncy limit
			//pjd.Initialize(ground, body, b2::Vec2(-10.0f, 10.0f), b2::Vec2(1.0f, 0.0f));
			...
			m_joint = (b2::PrismaticJoint*)m_world->CreateJoint(&pjd);
		}
	}
	...
	void Step(Settings* settings)
	{
		...
		b2::float32 force = m_joint->GetMotorForce(settings->hz);
