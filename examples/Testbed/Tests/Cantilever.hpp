...
#ifndef CANTILEVER_HPP
#define CANTILEVER_HPP
	...
	Cantilever()
	{
...

		{
			...
			for (b2::int32 i = 0; i < e_count; ++i)
			{
				...
				b2::Vec2 anchor(-15.0f + 1.0f * i, 5.0f);
...

		{
			...
			for (b2::int32 i = 0; i < 3; ++i)
			{
				...
				b2::Vec2 anchor(-15.0f + 2.0f * i, 15.0f);
				jd.Initialize(prevBody, body, anchor);
				m_world->CreateJoint(&jd);
...

		{
			...
			for (b2::int32 i = 0; i < e_count; ++i)
			{
				...
				if (i > 0)
				{
					b2::Vec2 anchor(-5.0f + 1.0f * i, 5.0f);
					jd.Initialize(prevBody, body, anchor);
					m_world->CreateJoint(&jd);
				}
...

		{
			...
			for (b2::int32 i = 0; i < e_count; ++i)
			{
				...
				if (i > 0)
				{
					b2::Vec2 anchor(5.0f + 1.0f * i, 10.0f);
					jd.Initialize(prevBody, body, anchor);
					m_world->CreateJoint(&jd);
				}
