...
#ifndef VERTICAL_STACK_HPP
#define VERTICAL_STACK_HPP
...
public:
	...
	{
		{
			...
			shape.Set(b2::Vec2(20.0f, 0.0f), b2::Vec2(20.0f, 20.0f));
			ground->CreateFixture(&shape, 0.0f);
		}

		b2::float32 xs[5] = {0.0f, -10.0f, -5.0f, 5.0f, 10.0f};
	...
	void Keyboard(int key)
	{
		...
		case GLFW_KEY_COMMA:
...

			{
				...
				m_bullet->SetLinearVelocity(b2::Vec2(400.0f, 0.0f));
			}
			break;
	...
	b2::Body* m_bullet;
	b2::Body* m_bodies[e_rowCount * e_columnCount];
	b2::int32 m_indices[e_rowCount * e_columnCount];
};
