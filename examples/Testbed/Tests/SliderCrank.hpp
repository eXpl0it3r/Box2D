...
public:
	SliderCrank()
	{
...

		{
			...
			// Define crank.
			{
				...
				rjd.Initialize(prevBody, body, b2::Vec2(0.0f, 5.0f));
				rjd.motorSpeed = 1.0f * b2::pi;
				rjd.maxMotorTorque = 10000.0f;
				rjd.enableMotor = true;
				m_joint1 = (b2::RevoluteJoint*)m_world->CreateJoint(&rjd);
			...
			// Define follower.
			{
				...
				b2::RevoluteJointDef rjd;
				rjd.Initialize(prevBody, body, b2::Vec2(0.0f, 9.0f));
			...
			// Define piston
			{
				...
				b2::RevoluteJointDef rjd;
				rjd.Initialize(prevBody, body, b2::Vec2(0.0f, 17.0f));
				m_world->CreateJoint(&rjd);

				b2::PrismaticJointDef pjd;
				pjd.Initialize(ground, body, b2::Vec2(0.0f, 17.0f), b2::Vec2(0.0f, 1.0f));

				pjd.maxMotorForce = 1000.0f;
				pjd.enableMotor = true;

				m_joint2 = (b2::PrismaticJoint*)m_world->CreateJoint(&pjd);
			}
	...
	void Step(Settings* settings)
	{
		...
		b2::float32 torque = m_joint1->GetMotorTorque(settings->hz);
